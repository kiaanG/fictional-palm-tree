...
export default class Batting extends React.Component {
  render() {
    return (
      <SafeAreaProvider>
        <View style={{backgroundColor:'black'}}>
          <Image
            source={require('../assets/Batting.png')}
            style={{ width: 300, height: 100, alignSelf: 'center' }}
            resizeMode="contain"
          />
          <View>
          <Image
            source={require('../assets/batsmen.jpeg')}
          ...
          <View>
          <Image
            source={require('../assets/bat_text.png')}
            style={{ width: 325, height: 400, alignSelf: 'center' }}
            resizeMode="contain"
          />
          </View>
