...
export default class Fielding extends React.Component {
  render() {
    return (
      <SafeAreaProvider>
        <View style={{backgroundColor:'black'}}>
          <Image
            source={require('../assets/Fielding.png')} 
            style={{ width: 300, height: 100, alignSelf: 'center' }}
            resizeMode="contain"
          />
          <View>
          <Image
            source={require('../assets/Fielders.png')}
          ...
          <View>
          <Image
            source={require('../assets/field_text.png')}
            style={{ width: 325, height: 400, alignSelf: 'center' }}
            resizeMode="contain"
          />
          </View>
